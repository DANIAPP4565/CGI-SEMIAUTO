...
VARIABLES_CGI: Dict[str, List[str]] = {
    ...
    "lvet": ["lvet", "tevi", "tiempo de eyeccion", "tiempo de eyección"],
...
RANGOS: Dict[str, Tuple[float, float]] = {
    ...
    "ds": (10, 250), "ids": (5, 150), "lvet": (150, 500), "z0": (5, 80),
}
...
def clave_por_texto(texto: Any) -> Optional[str]:
    ...
    for clave in ["cftnr", "irv", "rvs", "iac", "ih", "cts", "ava", "ic", "gc", "ca", "cft", "iv", "ea", "ees", "ds", "ids", "pas", "pad", "fc", "lvet", "z0", "paciente", "dni", "edad", "sexo", "peso", "talla", "imc", "superficie_corporal", "fecha_estudio", "diagnostico", "posicion"]:
...
def generar_pdf_informe(df: pd.DataFrame, morfo: Optional[Dict[str, Any]] = None) -> bytes:
    ...
    mostrar = ["ic", "gc", "irv", "rvs", "ca", "cft", "cftnr", "iv", "iac", "ih", "cts", "ea", "ees", "ava", "ds", "ids", "lvet", "z0"]
...
st.markdown("<div class='card'>", unsafe_allow_html=True)
st.subheader("4. Analisis morfologico semiautomatico de señal ICG")
st.write(
